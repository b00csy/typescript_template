...
module.exports = function(
  ...
  if(answer.lang) {
    ...
    console.log();
    console.log(JSON.stringify(appPackage.dependencies) + 'Hi bro!');
    console.log('Happy hacking!');

  } else {
    const templatePath = templateNoLang
      ? path.resolve(originalDirectory, templateNoLang)
      : path.join(ownPath, 'templateNoLang');
    if (fs.existsSync(templatePath)) {
      fs.copySync(templatePath, appPath);
    } else {
      console.error(
